package com.example.bt_radbtn_checkbox;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editCMND=(EditText) findViewById(R.id.editText2);
        editBosung=(EditText) findViewById(R.id.editText3);
        chkdocbao=(CheckBox) findViewById(R.id.checkBox1);
        chkdoccode=(CheckBox) findViewById(R.id.checkBox2);
        chkdocsach=(CheckBox) findViewById(R.id.checkBox3);
